  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
        ...
        <h2 className="text-2xl font-bold mb-4">PayPal Payment Cancelled</h2>
        <p className="text-gray-600 mb-6">
          Your PayPal payment was cancelled. No charges have been made to your account.
        </p>
        <div className="bg-orange-50 border border-orange-200 rounded-md p-4 mb-6">
          <p className="text-orange-800 text-sm">
            You can try again with PayPal or choose a different payment method from the upgrade page.
          </p>
        </div>
