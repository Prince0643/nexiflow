...
export default function TaskBoard({ 
  ...
  return (
    <div className="h-full">
      {/* Board */}
      <div className="flex overflow-x-auto overflow-y-auto gap-4 pb-2">
        {statuses.map((status) => {
          ...
          return (
            ...
            >
              {/* Status Header */}
              <div className={`${status.color} border rounded-lg p-3 mb-3`} style={{ backgroundColor: status.color + '20', borderColor: status.color }}>
              ...
              <div className="space-y-2.5 max-h-[calc(100vh-200px)] overflow-y-auto">
                {statusTasks.map((task) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 hover:shadow-md dark:hover:shadow-lg transition-shadow cursor-pointer group"
                    >
                      {/* Task Header */}
                      ...
                      {/* Task Description */}
                      {task.description && (
                        <p className="text-xs text-gray-600 dark:text-gray-300 mb-2.5 line-clamp-2">
                          {task.description}
                        </p>
                      )}
                      ...
                      <div className="mt-2.5 pt-2.5 border-t border-gray-100 dark:border-gray-700">
                        <div className="flex flex-wrap gap-1">
                          {task.tags.map((tag, index) => (
                            <span
                              key={index}
                              className="px-1.5 py-0.5 text-[11px] bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-full"
                            >
                              {tag}
                            </span>
                          ))}
                ...
                <button
                  ...
                  className="w-full p-3 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg text-gray-500 dark:text-gray-400 hover:border-gray-400 dark:hover:border-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors group"
                >
